                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,unit,tgl_surat,
                                                                tgl_catat,file,keterangan,id_user)
                                                                VALUES('$no_agenda','$tujuan','$no_surat','$isi','$nunit','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,unit,tgl_surat,
                                                        tgl_catat,file,keterangan,id_user)
                                                        VALUES('$no_agenda','$tujuan','$no_surat','$isi','$nunit','$tgl_surat',NOW(),'','$keterangan','$id_user')");
