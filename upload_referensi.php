                    ...
                    if($eks == 'csv'){
                        ...
                        while(($data = fgetcsv($handle, 1000, ",")) !== FALSE){
                            ...
                            //insert data ke dalam database
                             $query = mysqli_query($config, "INSERT into tbl_klasifikasi(id_klasifikasi,unit,nama,uraian,id_user) values(null,'$data[1]','$data[2]','$data[3]','$id_user')");
                        }
                        fclose($handle);
                    ...
                    <div class="col m12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title black-text">Import Referensi Unit Surat</span>
                                <p class="kata">Silakan pilih file unit berformat *.csv (file excel) lalu klik tombol <strong>"Import"</strong> untuk melakukan import file. Contoh format file csv bisa di download melalui link dibawah ini.</p><br/>';
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="file-field input-field col m6">
                                        ...
                                        <div class="file-path-wrapper">
                                            <input class="file-path validate" placeholder="Upload file csv unit klasifikasi" type="text">
                                         </div>
                                    </div>
