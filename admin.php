            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                echo "<strong>Sekretaris</strong>. Anda memiliki akses penuh terhadap arsip surat.";
                            } elseif($_SESSION['admin'] == 2){
                                echo "<strong>IT Control</strong>. Anda memiliki akses terhadap user ARSIP MANAJEMEN SURAT.";
                             } elseif($_SESSION['admin'] == 3){
                                echo "<strong>Bagian Disposisi</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            } elseif($_SESSION['admin'] == 4){
                                echo "<strong>Client</strong>. Berikut adalah statistik data yang tersimpan dalam Dataa.";                                    
                            }?></p>
                    </div>
                </div>
            </div>
