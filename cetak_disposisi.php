<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    $query2 = mysqli_query($config, "SELECT institusi, nama, website, alamat, logo FROM tbl_instansi");
                    list($institusi, $nama, $website, $alamat, $logo) = mysqli_fetch_array($query2);
                        echo '<img class="logodisp" src="./upload/'.$logo.'"/>';
                        echo '<h6 class="up">'.$institusi.'</h6>';
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                        echo '<span id="alamat">Jl. Sutisna Senjaya No.101 Tasikmalaya Telp: (0265)-334464 Fax: (0265)-330884</span>';
                        echo '<h6 class="website">'.$website.'</h6>';
                    ...
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="left" width="25"><strong>Unit</strong> : '.$row['unit'].'</td>
                            </tr>
            ...
            <div id="lead">
                <p>Kepala Cabang</p>
                <div style="height: 50px;"></div>';
                $query = mysqli_query($config, "SELECT kacab, nip FROM tbl_instansi");
                list($kacab,$nip) = mysqli_fetch_array($query);
                if(!empty($kacab)){
                    echo '<p class="lead">'.$kacab.'</p>';
                } else {
                    echo '<p class="lead">Ahmad Mahdar</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
                } else {
