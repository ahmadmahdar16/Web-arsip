                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nunit)){
                                    $_SESSION['unit'] = 'Form unit hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan koma(,)';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,unit,indeks,tgl_surat,
                                                                    tgl_diterima,file,keterangan,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nunit','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,unit,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nunit','$indeks','$tgl_surat',NOW(),'','$keterangan','$id_user')");
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="unit" type="text" class="validate" name="unit" required>
                                <?php
                                    if(isset($_SESSION['unit'])){
                                        $unit = $_SESSION['unit'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$unit.'</div>';
                                        unset($_SESSION['unit']);
                                    }
                                ?>
