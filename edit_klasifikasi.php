                ...
                if(!preg_match("/^[a-zA-Z0-9. ]*$/", $unit)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                            ...
                            $query = mysqli_query($config, "UPDATE tbl_klasifikasi SET unit='$unit', nama='$nama', uraian='$uraian', id_user='$id_user' WHERE id_klasifikasi='$id_klasifikasi'");
                        ...
                        <form class="col s12" method="post" action="?page=ref&act=edit">
                            ...
                            <div class="row">
                                <div class="input-field col s3">
                                    ...
                                    <input id="kd" type="text" class="validate" name="unit" maxlength="30" value="<?php echo $row['unit']; ?>" required>
                                        <?php
